<template>
    <div class="feedbackPage">
        <div class="content-list-box">
           <div class="arror-left"  @click="PreviousStep()">
                <van-icon name="arrow-left" />
            </div>
            <van-swipe class="my-swipe" autoplay="" indicator-color="#fff" @change="onChange" indicator-position="none" :interval="5000"  ref="nop">
                <van-swipe-item>
                    <div class="list">
            ...
            <div class="arror-right" @click="nextStep()">
                <van-icon name="arrow" />
            </div>
