<template>
    <div class="productShieldPage">
        ...
        <div class="img-list">
            <img src="@/assets/img/new1203/01.png?v=1224" alt="" srcset="">
        </div>
        <div class="link-list" style="margin-top:-8vw">
        ...
        <div class="img-list">
            <img src="@/assets/img/new1203/02.png?v=1230" alt="" srcset="">
        </div>
        <div class="img-list" style="margin-top:4vw">
            <img src="@/assets/img/new1203/03.png" alt="" srcset="">
        </div>
        <div class="img-list" style="margin-top:4vw">
            <img src="@/assets/img/new1203/04.png" alt="" srcset="">
        </div>
        <div class="link-list" style="margin-top:4vw">
            <a href="https://mp.weixin.qq.com/s/HYZFz2Z88PWgWfGt2j-Qjw">详见：重磅| 国际肺癌研究协会ISALC 液体活检热点会议 循环异常细胞（CAC）在5-10mm肺部小结节中的良恶性诊断效能</a> 
        </div>
        <div class="img-list" style="margin-top:4vw">
            <img src="@/assets/img/new1203/05.png" alt="" srcset="">
        </div>
        <div class="list13" style="margin-top:4vw">
...
export default {
    ...
    methods:{
        ...
        goUserPage(){
            ...
            if(mobile && mobile!=''){
                ...
                Dialog.confirm({
                   ...
                   this.$router.push({path:'/login',query:{path:'shield'}});
                }).catch(() => {
                });
            }
        },
        ...
        payWx(){
            let that  = this;
            that.$router.push('/productDetail');
        },  
        //联系我们弹窗
        callUs(){
            console.log('1111')
...
.productShieldPage .top1-bg{
    width: 100%;
    text-align: center;
    margin-top: 45px;
}
.productShieldPage .top1-bg img{
    width: 90%;
    object-fit: fill;
}
...
.productShieldPage .technological-invention .Top  span{
    width: 10px;
    height: 10px;
    border-radius: 100%;
    background: #008086;
...
.productShieldPage .technological-invention .expert{
    width: 100%;
    margin-top: 49px;
    text-align: center;
}
.productShieldPage .technological-invention .expert img{
    width: 100%;
}
.productShieldPage .technological-invention .link-list{
    text-align: left;
    padding: 0 25px;
    box-sizing: border-box;
    margin-top: -120px;
...
.productShieldPage .CAC-list .list6 img{
    width: 100%;
    height: 100%;
    object-fit: fill;
}
.productShieldPage .CAC-list .list6 p{
    ...
    color: #ffffff;
    line-height: 46px;
    text-shadow: 10px 10px 7px 1px #084059; 
    margin-left: 30px;
}
...
.productShieldPage .CAC-list .list7 p:nth-of-type(1){
     margin-top: 37px;
}
...
.productShieldPage  .CAC-text-list div a{
    font-size: 14px;
    font-family: SourceHanSansCN, SourceHanSansCN-Normal;
}
...
.productShieldPage .img-list{
    width: 100%;
}
.productShieldPage .img-list img{
    width: 100%;
    object-fit: fill;
}
